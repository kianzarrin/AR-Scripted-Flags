// NOTE: put the following dlls in the project directory: AdaptiveRoads, Assembly-CSharp, ColossalManaged, UnityEngine
using AdaptiveRoads.Manager;
namespace ANExpression {
    using System;
    ...
    public class ANExpression : PredicateBase {
